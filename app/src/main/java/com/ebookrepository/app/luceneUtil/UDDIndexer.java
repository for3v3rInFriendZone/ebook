...
public final class UDDIndexer {
	...
	private IndexWriterConfig iwc = new IndexWriterConfig(matchVersion, new SerbianAnalyzer(matchVersion));
	...
	private void openIndexWriter() throws IOException{
		iwc = new IndexWriterConfig(matchVersion, new StandardAnalyzer(matchVersion));
	 ...
	 */
	public DocumentHandler getHandler(File file){
