...
INSERT INTO ebook (title, author, keywords, profile_image, publication_year, filename, mime, category, language, ebookuser) VALUES ('Green mile', 'Stephen King', 'prison, fantasy', 'http://ecx.images-amazon.com/images/I/51MHN3SW6XL.jpg',1996, 'dasdas.pdf', 'application/pdf', 2, 1, 1);
INSERT INTO ebook (title, author, keywords, profile_image, publication_year, filename, mime, category, language, ebookuser) VALUES ('Headhunters', 'Jo Nesbo', 'thriller, action', 'http://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1320551831i/11777020._UY450_SS450_.jpg', 2011, 'dasadasd.pdf', 'application/pdf', 1, 3, 3);
INSERT INTO ebook (title, author, keywords, profile_image, publication_year, filename, mime, category, language, ebookuser) VALUES ('A Farewell to Arms', 'Ernest Hemingway', 'war, love, friends', 'https://libcom.org/files/images/library/a_farewell_to_arms_0.jpg', 1929, 'dasadassds2d.pdf', 'application/pdf', 7, 1, 2);
